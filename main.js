...
Status_badtameez=badtameez_dil.isPlaying()
...
if(Status_party===false){
    ...
    if(score_rightwrist>0.2){
        ...
        Party_On_My_Mind.stop()
        if(Status_badtameez===false){
            badtameez_dil.play()
            console.log("play")
            document.getElementById("Song-Name").innerHTML="Playing Badtameez dil"
        }
